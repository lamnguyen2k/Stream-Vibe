...
import imgFilm from './image/Sub Container.png';
            ...
            seasons: [
                {
                    ...
                    iconTime: iconTime,
                    time: '49min',
                    titleFilm: 'Chapter One : The Vanishing of Will Byers',
                    contentFilm:
                    ...
                    <div className=" flex flex-col bg-zinc-800 rounded-lg mt-5 mb-5 pb-10">
                        ...
                        <div className="mx-10">
                            {season.map((value, index) => {
                                return <SeasonFilm key={index} data={value} items={value.seasons} />;
                            })}
                        </div>
                    </div>
